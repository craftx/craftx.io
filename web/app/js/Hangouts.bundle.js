...
var _jstz = __webpack_require__(92);
...
new _vue2.default({
    ...
    mounted: function mounted() {
        ...
        this.$nextTick(function () {
            _this.timezone = _jstz2.default.determine().name();

            if (_this.timezone) {
                (0, _Utils.postToController)('hangouts/default/get-date-time-data', {
                    sourceDateTime: window.hangoutSourceDateTime,
                    destinationTimeZone: _this.timezone
                }, function (response) {
                    if (response.data.success) {
                        _this.day = response.data.day;
                        _this.date = response.data.date;
                        _this.time = response.data.time;
                        _this.zoneIdentifier = response.data.zoneIdentifier;
                        _this.zoneAbbreviation = response.data.zoneAbbreviation;
                    } else {
                        _this.timezone = null;
                    }
                }, function () {
...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
    module.exports = jstz;
} else if (("function" !== 'undefined' && __webpack_require__(169) !== null) && (__webpack_require__(170) != null)) {
